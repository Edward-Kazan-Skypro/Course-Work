public class MassiveManager {
    ...
    //Поясню. Было бы удобнее работать не с массивом (который жестко ограничен по размеру и
    ...
    //Массив markers - это тень, которую отбрасывают элементы массива employees,
    //т.е. если есть элемент массива employees, то есть его тень в массиве markers.
